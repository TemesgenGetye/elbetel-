        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between">
          <div className="w-full md:w-1/2 text-center md:text-left mb-12 md:mb-0">
            ...
            <h3 className="text-xl md:text-2xl font-medium text-gray-700 dark:text-gray-300 mb-8">
              <span className="block mb-2">Social Media Manager</span>
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-lg mx-auto md:mx-0 mb-8">
              I bring brands to life through engaging social media strategies
              and captivating content creation, while leveraging my HR expertise
              to build meaningful connections and drive results. I hold a BSc
              degree in Information Technology from Bahir Dar University and am
              currently pursuing a second BSc in Management at Unity University.
            </p>
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-white dark:border-gray-300 shadow-xl">
              <img
                src="./elb2.png"
